  ...
  render() {
    return (
      <div style={this.props.style}>
        ...
        <p>After filtering (see below), an average of 30 packages are published every day. It is then perfectly readable, and believe me, it's worth it! :)</p>
        ...
        <p>Anyway,  the adoption will take time, so until then, I filter the packages based on the number of GitHub stars. A minimum of {this.app.minimumGitHubStars} stars is required for a package to be listed. I know it's not perfect, all packages are not hosted by GitHub, but it's a start.</p>
