...
export class Header extends React.Component {
  ...
  render() {
    return (
      <header style={[{ display: 'flex', alignItems: 'center', padding: '.85rem 1rem .75rem .75rem', borderBottomWidth: s.$borderWidth, borderBottomStyle: 'solid', borderBottomColor: s.$borderColor }]}>
